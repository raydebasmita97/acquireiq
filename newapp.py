...
st.markdown("<p style='color:#555;'>Intelligent Lead Qualification for Business Acquisitions</p>", unsafe_allow_html=True)
st.divider()
...
with col1:
    st.markdown("""
        ...
        <p style='color:#cce; margin:0.5rem 0 0; font-size:0.9rem;'>AI assistant and dashboards for newly placed CEOs</p>
        </a>
...
with col2:
    st.markdown("""
        ...
        <p style='color:#cce; margin:0.5rem 0 0; font-size:0.9rem;'>Manage knowledge base, data, and dashboards</p>
        </a>
    """, unsafe_allow_html=True)
